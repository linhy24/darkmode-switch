/*
    Controls dark mode switch of the website
*/

// svg icon for light and dark theme indicator
var lightIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sun" viewBox="0 0 16 16">
...
var darkIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon" viewBox="0 0 16 16">
...
if (document.getElementById("toggle").checked == true) {
    if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
        ...
        document.getElementById("theme").innerHTML = lightIcon
    }
} else {
    document.getElementById("theme").innerHTML = lightIcon
}

// An EventListener that monitors system theme change and change the theme indicator correspondingly
